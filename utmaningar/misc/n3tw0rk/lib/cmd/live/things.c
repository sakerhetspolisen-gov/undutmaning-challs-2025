...
look(string str, int brief)
{
    ...
    *obl,
    ...
    str = lower_case(str);
	/* Unsure why this check is here... Hopefully removing it does not screw stuff up...
    tmp = explode(str, " ");
	...
	*/
    ...
    if (prplc != "at" && prplc != "in" && prplc != "inside" && prplc != "prp_examine")
    {
